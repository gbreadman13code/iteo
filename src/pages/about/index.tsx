      ...
      <div className="about-page__hero">
        <div className="about-page__team-container">
          <div className="about-page__hero__text">
            ...
            <p>Любим и&nbsp;умеем справляться со&nbsp;сложными задачами. Создаем интерактивные решения, улучшающие жизнь и&nbsp;открывающие новый уровень восприятия окружающего мира.</p>
          </div>
