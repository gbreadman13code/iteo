      ...
      <div className="about-page__hero">
        <div className="about-page__team-container">
          <div className="about-page__hero__text">
            <p>
              <span>Итео — команда</span> дизайнеров, программистов и&nbsp;техников, <br /> реализующая проекты современных музеев и&nbsp;выставочных стендов от идеи до&nbsp;монтажа на объекте. <br /> Опыт создания интерактивных инсталляций с 2014 года. <br /> В нашем штате 22 квалифицированных специалиста.
            </p>
            <p>
              <span>Мы любим и умеем</span> точно решать сложные бизнес-задачи разных компаний и&nbsp;делать лучше жизнь людей - с помощью интерактивных решений. <br /> Мы делаем доступным новый уровень восприятия окружающего мира, поможем Вашему бизнесу соответствовать вызовам современности!
            </p>
          </div>
