...
export const projects: ProjectData[] = [
  {
    ...
    description: 'Инновационный кинетический макет «Красноярск 2018–2028» был успешно реализован совместно с мастерской M3D. Локация наглядно показала наш родной край посетителям выставки в Москве, а позже вернулась домой, в Красноярск, где стала частью Национального центра «Россия». ',
    list: ['Разработка интерактивной локации «Сила сибирских рек»', 'Создание интерактивной презентации', '3D-моделирование, анимации, производство видеоматериалов'],
    images: {
      main: RussiaVdnhMain,
  ...
  },
  {
    ...
    description: 'Совместная работа с мастерской М3D позволила более подробно рассказать об уникальной архитектуре Норильска и её обновлении в последние годы.',
    list: ['Создание интерактивной презентации', 'Подбор, закупка оборудования', 'Разработка системы управления освещением для макета', 'Моушн-дизайн'],
    images: {
      main: NorilskMain,
  ...
  },
  {
    ...
    title: {
      ...
      subtitle: 'КРАСНОЯРСКОГО КРАЯ',
      short: 'Национальный центр «Россия»',
    },
    description: 'Комплексное участие команды в проектировании, подготовке и работе многих интерактивных локаций национального центра. ',
    list: ['Создание более 30 интерактивных презентаций', 'Разработка видеоматериалов и анимации', '3D-моделирование', 'Инжиниринг кинетических экспонатов', 'Подбор, закупка и монтаж оборудования'],
    images: {
